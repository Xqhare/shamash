...
pub fn no_internet(term_now: Arc<AtomicBool>, adapter_name: String, load_map: BTreeMap<String, VecDeque<u64>>) {
    ...
    write(log_path, xff_value).expect("Failed to write log file");
